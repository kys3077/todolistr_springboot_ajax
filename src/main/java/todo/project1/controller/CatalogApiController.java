...
import todo.project1.mapper.CatalogMapper;
...
public class CatalogApiController {
    ...
    public CatalogApiController(CatalogMapper mapper) {
        this.mapper = mapper;
    }

    @GetMapping("/read")
    public List<Catalog> getCatalogList(){
        return mapper.getCatalogList();
    }
    ...
    @PostMapping("/update")
    int updateCatalog(@RequestParam("id") String id, @RequestParam("title") String title, @RequestParam("content") String content, @RequestParam("this_date") String this_date){
        return mapper.updateCatalog(id, title, content, this_date);
    }

    @DeleteMapping("/delete")
    int deleteCatalog(@RequestParam("id") String id){
        return mapper.deleteCatalog(id);
    }
