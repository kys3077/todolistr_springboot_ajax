...
public interface CatalogMapper {
    ...
    int insertCatalog(@Param("id")String id, @Param("title") String title, @Param("content") String phone, @Param("this_date") String this_date);

    @Update("UPDATE CATALOG SET title=${title}, content=${content}, this_date=${this_date} WHERE id=${id}")
    int updateCatalog(@Param("id") String id, @Param("title") String title, @Param("content") String phone, @Param("this_date") String this_date);
